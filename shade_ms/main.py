...
from . import cli, plot_parameters
...
def main(argv):
    ...
    [xaxes, yaxes, columns, caxes, aaxes,
     areds, xmins, xmaxs, ymins, ymaxs,
     amins, amaxs, cmins, cmaxs, cnums,
     chanslice, chanslice_spec] = plot_parameters(parser, options)
